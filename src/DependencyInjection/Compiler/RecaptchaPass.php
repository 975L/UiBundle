...
// Moved from ContactFormBundle - a no-op unless karser/karser-recaptcha3-bundle is actually registered in the consuming app, so declaring it here doesn't force reCAPTCHA on every UiBundle consumer
