...
class TextSectionTypeTest extends TestCase
{
    ...
    // Captures the SUBMIT listener and fires it with $submittedData, returning the resulting data - mirrors what happens when a TextSection block form is submitted
